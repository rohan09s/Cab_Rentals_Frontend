    ...
    >
      ...
      {showFull && open && (
        <div className="md:hidden border-t border-gray-100 bg-gray-50 px-3 py-2 space-y-1 animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          <a
            href="tel:7709040404"
            className="flex items-center justify-center gap-2 text-white text-sm font-bold py-3 px-4 rounded-lg mt-2 mb-1 bg-red-600 hover:bg-red-700 active:bg-red-800 transition-colors duration-150"
          >
            📞 Call: 7709040404
          </a>
        </div>
