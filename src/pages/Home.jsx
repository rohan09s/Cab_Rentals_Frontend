...
const Home = () => {
  return (
    <div>
      {/* Hero */}
      <div id="home" className="bg-gradient-to-r from-blue-900 via-blue-700 to-blue-500 pt-8 sm:pt-12 md:pt-16 pb-20 sm:pb-24 md:pb-28 flex flex-col items-center justify-center text-white text-center px-4">
