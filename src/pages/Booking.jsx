  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      if (!configRes.ok) {
        ...
        console.error("❌ Failed to fetch Razorpay config:", configError);
        alert(`Payment setup failed: ${configError}`);
        return;
      }
      ...
      if (!razorpayKey) {
        alert("Payment setup failed: Razorpay key missing on server.");
        return;
      }
